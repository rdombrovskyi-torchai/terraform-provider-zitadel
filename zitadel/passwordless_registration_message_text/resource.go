package passwordless_registration_message_text
...
var (
	_ resource.Resource = &passwordlessRegistrationMessageTextResource{}
)

func New() resource.Resource {
	return &passwordlessRegistrationMessageTextResource{}
}

type passwordlessRegistrationMessageTextResource struct {
	clientInfo *helper.ClientInfo
}

func (r *passwordlessRegistrationMessageTextResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_passwordless_registration_message_text"
}

func (r *passwordlessRegistrationMessageTextResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
...
func (r *passwordlessRegistrationMessageTextResource) Configure(_ context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (r *passwordlessRegistrationMessageTextResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
...
func (r *passwordlessRegistrationMessageTextResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
...
func (r *passwordlessRegistrationMessageTextResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	language := getPlanAttrs(ctx, req.Plan, resp.Diagnostics)
	if resp.Diagnostics.HasError() {
		return
	}
...
func (r *passwordlessRegistrationMessageTextResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var state types.Object
	diags := req.State.Get(ctx, &state)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
