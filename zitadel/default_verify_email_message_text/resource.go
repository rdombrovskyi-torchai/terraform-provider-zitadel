package default_verify_email_message_text
...
var (
	_ resource.Resource = &defaultVerifyEmailMessageTextResource{}
)

func New() resource.Resource {
	return &defaultVerifyEmailMessageTextResource{}
}

type defaultVerifyEmailMessageTextResource struct {
	clientInfo *helper.ClientInfo
}

type defaultVerifyEmailMessageTextModel struct {
	OrgID types.String `tfsdk:"org_id"`
	ID    types.String `tfsdk:"id"`
	// Add other fields as needed
}

func (r *defaultVerifyEmailMessageTextResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_default_verify_email_message_text"
}

func (r *defaultVerifyEmailMessageTextResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
...
func (r *defaultVerifyEmailMessageTextResource) Configure(_ context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (r *defaultVerifyEmailMessageTextResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
...
func (r *defaultVerifyEmailMessageTextResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
...
func (r *defaultVerifyEmailMessageTextResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	language := getPlanAttrs(ctx, req.Plan, resp.Diagnostics)
	if resp.Diagnostics.HasError() {
		return
	}
...
func (r *defaultVerifyEmailMessageTextResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var state types.Object
